...
const HELP_LINES = [
  ...
  'play adventure     Abrir aventura de texto interactiva.',
...
const ADVENTURE_ROOMS = {
  terminal: {
    title: 'TERMINAL NODE',
    description: 'Una consola industrial parpadea frente a ti. Una puerta conduce al núcleo.',
    exits: { norte: 'core', n: 'core' },
  },
  core: {
    title: 'CONTROL CORE',
    description: 'El núcleo contiene un panel verde y una tarjeta de acceso junto a la salida.',
